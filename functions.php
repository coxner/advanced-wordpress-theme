<?php
	...
	function adv_theme_support(){
		...
		// Post Format Support (Can find on codex under post formats)
	...
	// returns the children of parent pages
	...
	// if it returns more then 0 pages then we know its a parent can then put this
	// into a if statement
